...
CREATE TABLE `talleres` (
  ...
  CONSTRAINT `talleres_ibfk_1` FOREIGN KEY (`id_oferta`) REFERENCES `ofertas` (`id_oferta`)
...
INSERT INTO `talleres` VALUES (8201,1002,'Taller Git: flujo de trabajo profesional');
...
-- Dump completed on 2025-12-09 10:04:53
