...
CREATE TABLE `seminarios` (
  ...
  `nombre_seminario` varchar(100) NOT NULL,
  PRIMARY KEY (`id_seminario`),
  KEY `id_oferta` (`id_oferta`),
  CONSTRAINT `seminarios_ibfk_1` FOREIGN KEY (`id_oferta`) REFERENCES `ofertas` (`id_oferta`)
...
INSERT INTO `seminarios` VALUES (8301,1004,'Seminario: buenas prácticas de programación');
...
-- Dump completed on 2025-12-09 10:04:42
