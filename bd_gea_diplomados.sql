...
CREATE TABLE `diplomados` (
  ...
  `titulo_diplomado` varchar(100) NOT NULL,
  PRIMARY KEY (`id_diplomado`),
  KEY `id_oferta` (`id_oferta`),
  CONSTRAINT `diplomados_ibfk_1` FOREIGN KEY (`id_oferta`) REFERENCES `ofertas` (`id_oferta`)
...
INSERT INTO `diplomados` VALUES (8001,1003,'Diplomado en Desarrollo Web Full Stack');
...
-- Dump completed on 2025-12-09 10:04:44
